...
export const TableComp = ({ selectedOption }) => {
  ...
  const lappURL =
  process.env.REACT_APP_LAPP_URL;
    ...
    const formated = array?.map((item) => {
      if (item["mx_Status"] === "Booked") {
        return {
          ...
          plan: getTableButton("View Plan"),
          salesOffer: getTableButton("Generate Sales Offer"),
          status: getTableButton("Cancel"),
        };
        ...
        return {
          ...
          plan: getTableButton("View Plan"),
          salesOffer: getTableButton("Generate Sales Offer"),
          status: getTableButton("Sold Out"),
        };
      }
    });
    return formated;
